<?php
    ...
    $username1 = $password = $iname = $bday= $nic = $contactnumber = $addresss = $post = "";
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if (empty($_POST['password'])){
            ...
            $lname = validate($_POST['password']);
            if (!preg_match('/^([a-zA-Z0-9@#]+)$/',$lname)){
                $errors['password'] = "Not in a correct Formate";
            }
        }
...
<!--Form2-->
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"])?>" method="POST" class="form2">
        ...
        <div class="commonclass">
            ...
            <textarea name="address" value="<?php echo validate($address)?>" name="adddress" id="textarea" rows="4" cols="50"></textarea><br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
            <span class="error" ><?php echo $errors["address"];?></span>
        </div> 

        <div class="commonclass">
            <label for="username">Username : </label><br>
            <input type="text" value="<?php echo validate($username1)?>" id="firstname" name="username1">
            <span class="error" style="margin-left: 10%;"><?php echo $errors["username1"];?></span>
        </div>
    
        <div class="commonclass">
            <label for="password">Password :</label><br>
            <input type="password" value="<?php echo validate($password)?>" id="lastname" name="password"><br>
